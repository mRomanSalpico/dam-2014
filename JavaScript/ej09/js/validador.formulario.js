HTMLFormElement.prototype.validar = function(errores){
    ...
    var funcionRequired= function(e){
        var comprobar = APP.validador.required(this.value);
    ...
    var funcionPassword= function(e){
        var comprobar = APP.validador.password(this.value);
        if (!comprobar){
            funcionEnRojo(this);
    ...
    var funcionEmail= function(e){
        var comprobar = APP.validador.email(this.value);
        if (!comprobar){
            funcionEnRojo(this);
    ...
    var funcionComentario= function(e){
        var comprobar =APP.validador.comentario(this.value, this.dataset.max);
        if (!comprobar){
            funcionEnRojo(this);
